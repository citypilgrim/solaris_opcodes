...
UTCINFO = 8                                # [hrs], follows the time on computer
...
CALIWRITESIGFIG = 7
AFTPROTIMEFIELD, AFTPROBINTIMEFIELD, AFTPROBINNUMFIELD, AFTPROLIDARNAMEFIELD =\
    0, 1, 2, 3
AFTPROFILE = '_'.join([TIMEFMT, BINTIMEFMT, BINNUMFMT]) \
    + '_{}_afterpulse.txt'       # lidarname
OVERPROTIMEFIELD, OVERPROBINTIMEFIELD, OVERPROBINNUMFIELD, \
    OVERPROLIDARNAMEFIELD = 0, 1, 2, 3
OVERPROFILE = '_'.join([TIMEFMT, BINTIMEFMT, BINNUMFMT]) \
